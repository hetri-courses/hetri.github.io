              ...
              <div className="flex justify-center">
                <div className="relative" style={{ width: '200px', height: '400px' }}>
                  ...
                  <div className="absolute inset-0 bg-gray-900 rounded-[42px] p-2">
                    <div className="w-full h-full bg-gray-100 rounded-[36px] overflow-hidden relative">
                      {/* Dynamic Island */}
        ...
        <div className="container-max">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Complete facility management platform designed specifically for modern pet care operations
            </p>
          </div>
              ...
              <div className="flex justify-center">
                <div className="relative" style={{ width: '240px', height: '480px' }}>
                  ...
                  <div className="absolute inset-0 bg-gray-900 rounded-[48px] p-2">
                    <div className="w-full h-full bg-gray-100 rounded-[42px] overflow-hidden relative">
                      {/* Dynamic Island */}
